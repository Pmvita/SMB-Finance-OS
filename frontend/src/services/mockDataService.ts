...
class MockDataService {
  ...
  public async fetchUser() {
    const response = await fetch('/api/mockdata/user');
    if (response.ok) {
  ...
  public async fetchDashboard() {
    const response = await fetch('/api/mockdata/dashboard');
    if (response.ok) {
      return await response.json();
    }
  ...
  public async fetchInvoices() {
    const response = await fetch('/api/mockdata/invoices');
    if (response.ok) {
      return await response.json();
    }
  ...
  public async fetchExpenses() {
    const response = await fetch('/api/mockdata/expenses');
    if (response.ok) {
      return await response.json();
    }
  ...
  public async fetchWallet() {
    const response = await fetch('/api/mockdata/wallet');
    if (response.ok) {
      return await response.json();
    }
  ...
  public async fetchProfile() {
    const response = await fetch('/api/mockdata/profile');
    if (response.ok) {
      return await response.json();
    }
